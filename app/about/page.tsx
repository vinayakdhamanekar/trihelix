...
/** TriHelix About Us.dc.html — 1440x5344 design canvas, scaled to the viewport width.
  ...
  return (
    <>
      ...
      <div style={{ position: "absolute", left: "0", top: "46px", width: "1440px", height: "41px", pointerEvents: "none", fontSize: "16px", lineHeight: "21px", color: "#ffffff" }}>
        ...
        <Link className="navlink" aria-current="page" href={"/about"} style={{ position: "absolute", left: "1132px", top: "10px", pointerEvents: "auto" }}>About Us</Link>
      ...
      {/* HERO */}
      <h1 className="rise" style={{ position: "absolute", left: "100px", top: "172px", margin: "0", fontSize: "68px", lineHeight: "75px", fontWeight: "400", letterSpacing: "0.1px", whiteSpace: "nowrap" }}>Built from experience.<br />Created for what comes next.</h1>
      ...
      {/* CTA */}
      <div style={{ position: "absolute", left: "100px", top: "4329px", width: "1240px", height: "441px", borderRadius: "24px", overflow: "hidden", backgroundColor: "#1668a8", backgroundImage: "url('assets/about-cta-grad-2.webp')", backgroundSize: "100% 100%" , border: "1px solid rgba(255,255,255,0.14)"}}>
      ...
      <div className="only-mobile"><MobAbout /></div>
    </>
  );
}
