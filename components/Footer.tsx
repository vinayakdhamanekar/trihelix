...
export default function Footer({ top, current }: { top: number; current?: FooterLink }) {
  ...
  return (
    <>
      <Link href={"/"} aria-label={"TriHelix home"} style={{ position: "absolute", left: "100px", top: `${top}px`, display: "block", width: "242px" }}><img src={"/assets/logo-big.webp"} alt={"TriHelix"} style={{ display: "block", width: "242px" }} /></Link>
      <p style={{ position: "absolute", left: "100px", top: `${top + OFFSET.tagline}px`, margin: "0", fontFamily: "'IBM Plex Sans', sans-serif", fontSize: "12.5px", lineHeight: "20px", color: "rgba(255,255,255,0.7)" }}>TriHelix is a proprietary framework of Nihilent LTD.</p>
      <div style={{ position: "absolute", left: "100px", top: `${top + OFFSET.divider}px`, width: "1240px", height: "1px", background: "rgba(255,255,255,0.16)" }}></div>
      <div style={{ position: "absolute", left: "100px", top: `${top + OFFSET.grid}px`, width: "1240px", display: "grid", gridTemplateColumns: "212px 786px 242px", fontFamily: "'IBM Plex Sans', sans-serif", fontSize: "16.5px", lineHeight: "22px" }}>
      ...
      <p style={{ position: "absolute", left: "0", top: `${top + OFFSET.copyright}px`, width: "1440px", margin: "0", textAlign: "center", fontFamily: "'IBM Plex Sans', sans-serif", fontSize: "16.3px", lineHeight: "20px", color: "rgba(255,255,255,0.86)" }}>&copy; 2026 TriHelix. All rights reserved.</p>
      <div style={{ position: "absolute", left: "1208px", top: `${top + OFFSET.social}px`, display: "flex", alignItems: "center", gap: "22px" }}>
